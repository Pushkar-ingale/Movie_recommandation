...
filename = r'F:\Placement Course\Machine Learning Advanced\Movie_recommandation\nlp_model.pkl'
clf = pickle.load(open(filename, 'rb'))
vectorizer = pickle.load(open(r'F:\Placement Course\Machine Learning Advanced\Movie_recommandation\tranform.pkl','rb'))
...
def get_suggestions():
    data = pd.read_csv('F:\Placement Course\Machine Learning Advanced\Movie_recommandation\main_data.csv')
